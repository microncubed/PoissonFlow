...
def heater_continuous(c_out, rho_out, k_out, q_out, xc, c_dict, rho_dict, k_dict,
    ...
    if heater_metal:
        i = 7
        c_out[xc - 10:xc + 10, n_bound[i]:n_bound[i + 1]] = c_dict['ruthenium']
        rho_out[xc - 10:xc + 10, n_bound[i]:n_bound[i + 1]] = rho_dict['ruthenium']
        k_out[xc - 10:xc + 10, n_bound[i]:n_bound[i + 1]] = k_dict['ruthenium']
